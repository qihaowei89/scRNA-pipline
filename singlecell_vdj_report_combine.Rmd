...
<center>
![图 5 数据基础分析流程图](src/数据基础分析流程图合并样本.png){width=60%} 
</center> 
...
library(knitr)
library(kableExtra)
table1 = read.table(file = "2.Cellranger_advanced/Cluster_specific_genes/graphclust/graphclust.differential_expression.csv",sep = ",",header = T)
